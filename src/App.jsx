    ...
    const renderLeftGrid = () => {
        return Array.from({ length: 8 }).map((_, i) => {
            ...
            return (
                ...
                >
                    <img
                        src="/assets/cards/inspiration/card-inspiration-01.webp"
                        alt="Inspiration"
                        className="grid-img"
                    />
                </div>
    ...
    const renderRightGrid = () => {
        return Array.from({ length: 8 }).map((_, i) => {
            ...
            return (
                ...
                >
                    <img
                        src="/assets/cards/innovation/card-innovation-01.webp"
                        alt="Innovation"
                        className="grid-img"
                    />
                </div>
                                ...
                                <AnimatePresence>
                                    {showDescriptions && (
                                        ...
                                        >
                                            ...
                                            <p>
                                                Sa morphologie brise la
                                                résistance du courant pour
                                                glisser avec un effort minimal.
                                            </p>
                                        </motion.div>
                                    )}
                                </AnimatePresence>
                                ...
                                <AnimatePresence>
                                    {showDescriptions && (
                                        ...
                                        >
                                            <h3>Éoliennes</h3>
                                            <p>
                                                Ces pales géantes tournent même
                                                par vent très faible grâce à
                                                leur profil unique.
                                            </p>
                                        </motion.div>
                                    )}
                            ...
                            <AnimatePresence>
                                {linkStatus === "linked" && (
                                    ...
                                    >
                                        ...
                                        <p>
                                            Les bosses sur les nageoires de la
                                            baleine créent des micro-vortex qui
                                            améliorent sa portance. Sculptées de
                                            la même façon, ces pales d'éoliennes
                                            captent le vent avec beaucoup moins
                                            de frottement.
                                        </p>
                                    </motion.div>
                                )}
                            ...
                            <AnimatePresence>
                                {linkStatus === "idle" && wrongAttempt && (
                                    ...
                                    >
                                        ...
                                        <p>
                                            Observez comment une forme peut
                                            réduire l'effort d'un mouvement.
                                        </p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                ...
                {currentView === "sequence-2" && (
                    ...
                    >
                        <h2 className="transition-title">
                            S<span style={{ fontStyle: "italic" }}>é</span>
                            quence 2
                            <span
                                style={{
                        ...
                        <button
                            ...
                            onClick={() => setCurrentView("sequence-1")}
                        >
                            Commencer
                        </button>
                    </motion.main>
